...
final istvTopTabPages = <Widget>[
  CustomPage(panelColor: Colors.cyan, title: '1', key: UniqueKey()),
  CustomPage(panelColor: Colors.cyan, title: '22', key: UniqueKey()),
  CustomPage(panelColor: Colors.cyan, title: '333', key: UniqueKey()),
  CustomPage(panelColor: Colors.cyan, title: '444', key: UniqueKey()),
  CustomPage(panelColor: Colors.cyan, title: '55', key: UniqueKey()),
  CustomPage(panelColor: Colors.cyan, title: '6', key: UniqueKey()),
];
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: TabbedWidget(bottomTabs, topTabsList, pagesList),
